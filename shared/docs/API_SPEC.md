...
```json
{
  ...
  "data": {
    "token": "eyJhbGciOi...",
    "user": { "id": 1, "username": "admin", "nickname": "管理员", "roles": [{"id":1,"name":"ADMIN"}] }
  }
}
```
...
查询参数：page, page_size, sensor_device_id, metric_code
...
{
  "items": [
    { "sensor_channel_id": 1, "metric_code": "TEMP", "value": 25.5, "collected_at": "2026-01-01T12:00:00Z" },
    { "sensor_channel_id": 2, "metric_code": "HUMIDITY", "value": 65.0, "collected_at": "2026-01-01T12:00:00Z" }
  ]
}
```
...
{
  "batch_id": 1,
  "total_weight_kg": 150.500,
  "grades": [
    { "grade": "A", "weight_kg": 100.000, "count": 2 },
    { "grade": "B", "weight_kg": 50.500, "count": 1 }
  ]
}
```
...
请求体：CreateClimateProfileWithStagesRequest，包含温室配置信息及 stages 数组（每个 stage 可含 actions 数组）
...
```json
{
  ...
  "data": {
    "items": [
      { "record_type": "ELECTRICITY", "total_value": 500.5000, "unit": "kWh" },
      { "record_type": "WATER", "total_value": 2000.0000, "unit": "L" }
    ]
  }
}
```
